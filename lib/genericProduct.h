...
struct geneProdCompSpec{
	...
	int dataType; //data type of based product
   	...
   	int paraOpt; //auto decide the reso and range of base product
...
struct geneCompSite
{
	...
	int reso; //resolution of base product in meters
    int maxRange; //max range of base product in meters, Radius
};
...
struct geneGageData
{
	...
	float z; //ZR relation const
	float r; //ZR relation exponent
};
